...
def demo():
    import nltk
    text = "#4611REDEEMABLE IN STORE ONLY,8/1/16 8/14/16 SHOE SOURCEpurchase of $30 or more. Luused10 off any in-store Offer may be OfferPER valid including Shopko Otteonly once. Coupon valid in U.S. only, prohibited taxenot valid where otherwise restricted, $10 OFFexcludes gift cards and is not on purchases. Voidaltered, purchased or sold; not be posted or obtained on Internet. value is 1/50 cent.Coupon is not transferable and cannot Cash with other be combined $30 PURCHASE Coupons.have active "Message & data rates may apply. Customer must You text messaging plan to join & receive stated discount. consent to receiving text messages at the mobile phone number provide, including that be sent via Reply STOP to 747474 for stop. Max 8 msgs/month. Terms and 25 15 272 61 conditions apply. http://bit.ly/22ulQsQ.HURRY BACK. LIMITED TIMECoupon code 251527261Valid 8/1/2016 through 8/14/2016."
    print tag(text)
